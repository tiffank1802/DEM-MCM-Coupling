...
def markov_trajectory():
    ...
    trajectory = trajectory / trajectory.sum(axis=1, keepdims=True) * 100  # Scale to 100 particles
    return trajectory
...
class TestAnalyzeTransitionMatrix:
    ...
    def test_analyze_basic_matrix(self, stochastic_matrix):
    ...
    def test_condition_number_positive(self, stochastic_matrix):
...
class TestComputeRSD:
    ...
    def test_uniform_distribution_rsd(self):
    ...
    def test_segregated_distribution_rsd(self):
...
class TestValidateNormalization:
    ...
    def test_valid_trajectory(self, markov_trajectory):
...
class TestComputeEntropy:
    ...
    def test_zero_entropy_degenerate(self):
...
class TestCompareTrajectories:
    ...
    def test_identical_trajectories(self, markov_trajectory):
    ...
    def test_different_trajectories(self, segregated_trajectory, mixed_trajectory):
    ...
    def test_distance_symmetry(self, markov_trajectory):
...
class TestTrajectoryIntegration:
    ...
    def test_segregated_to_mixed_analysis(self, segregated_trajectory):
    ...
    def test_entropy_increase_over_time(self, segregated_trajectory):
    ...
    def test_convergence_to_steady_state(self, mixed_trajectory):
        """Test that well-mixed trajectory stays mixed."""
        rsd_evolution = np.array([
            compute_rsd(mixed_trajectory[t])
            for t in range(len(mixed_trajectory))
        ])
