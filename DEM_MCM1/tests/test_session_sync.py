...
class TestAppContextStateManagement:
    ...
    def test_add_model(self, app_context, sample_loaded_model):
    ...
    def test_add_duplicate_model(self, app_context, sample_loaded_model):
    ...
    def test_remove_model(self, app_context, sample_loaded_model):
    ...
    def test_version_increment_on_add(self, app_context, sample_loaded_model):
    ...
    def test_version_increment_on_remove(self, app_context, sample_loaded_model):
    ...
    def test_clear_models(self, app_context, sample_loaded_model):
    ...
    def test_get_model(self, app_context, sample_loaded_model):
...
class TestLoadedModelTypeSafety:
    ...
    def test_loaded_model_immutable(self, sample_loaded_model):
        """Test that LoadedModel is immutable."""
        with pytest.raises((AttributeError, TypeError)):
            sample_loaded_model.n_states = 200
    
    def test_loaded_model_repr(self, sample_loaded_model):
    ...
    def test_loaded_model_is_data_loaded_false(self, sample_loaded_model):
        """Test is_data_loaded when matrices not loaded."""
        assert not sample_loaded_model.is_data_loaded()
    
    def test_loaded_model_to_dict(self, sample_loaded_model):
...
class TestStateVectorValidation:
    ...
    def test_state_vector_normalization_valid(self):
    ...
    def test_state_vector_normalization_invalid(self):
    ...
    def test_state_vector_1d_only(self):
...
class TestTransitionMatrixProperties:
    ...
    def test_matrix_row_stochastic(self, sample_transition_matrix):
    ...
    def test_matrix_all_nonnegative(self, sample_transition_matrix):
        """Test that all elements are non-negative."""
        assert np.all(sample_transition_matrix >= 0)
    
    def test_matrix_eigenvalues_magnitude(self, sample_transition_matrix):
    ...
    def test_matrix_largest_eigenvalue(self, sample_transition_matrix):
...
class TestIntegrationScenarios:
    ...
    def test_workflow_load_multiple_models(self, app_context):
    ...
    def test_workflow_switch_active_model(self, app_context, sample_loaded_model):
    ...
    def test_workflow_filter_by_diameter(self, app_context):
        ...
        # Filter
        filtered = [
            m for m in app_context.selected_models
            if m.particle_diameter == 0.004
        ]
...
class TestEdgeCases:
    ...
    def test_empty_context_operations(self, app_context):
    ...
    def test_zero_particles_handling(self):
...
class TestModelLoaderCache:
    ...
    def test_get_or_load_hit(self, mock_open, mock_fs, sample_loaded_model):
