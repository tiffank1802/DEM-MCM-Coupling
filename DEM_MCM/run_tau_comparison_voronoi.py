# -*- coding: utf-8 -*-
"""
Étude comparative: Influence de tau sur la cinétique de mélange (Voronoi, 30 cellules, d=0.004)
...
folder_template = "voronoi_30cells_NLT20_step50_dt2_tau{tau}_start250_d0004"

print("\n🔍 Vérification des modèles tau (Voronoi 30 cellules) disponibles:")
available_tau = []
for tau in tau_list:
...
analyzer.plot_rsd_vs_tau_comparison(
    ...
    max_time_seconds=60,
    figsize=(14, 8),
    save_name="/kaggle/working/rsd_tau_comparison_voronoi_30cells.png",
    species_criterion="small"
)

print("\n✅ Étude comparative Voronoi (30 cellules, d=0.004) terminée!")
print(f"   Graphique sauvegardé: /kaggle/working/rsd_tau_comparison_voronoi_30cells.png")
