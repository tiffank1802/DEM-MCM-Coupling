...
class PartitionVisualizer:
    ...
    def load_particles(self, file_index=100, sample_every=1):
        ...
        Args:
            file_index: index du fichier à charger
    ...
    def show_all_methods(self, figsize=(24, 16), elev=25, azim=45):
        ...
        plt.savefig("partitioning_3d_comparison.png", dpi=200, bbox_inches="tight")
        plt.show()
        print("✅ Sauvegardé: partitioning_3d_comparison.png")
    ...
    def show_all_methods_2d(self, slice_axis="z", slice_frac=0.5, figsize=(24, 16)):
        ...
        plt.tight_layout()
        plt.savefig("partitioning_2d_comparison.png", dpi=200, bbox_inches="tight")
        plt.show()
        print("✅ Sauvegardé: partitioning_2d_comparison.png")
    ...
    def show_resolution_sweep(self, method="cartesian", figsize=(24, 12)):
        ...
        plt.savefig(f"resolution_sweep_{method}.png", dpi=200, bbox_inches="tight")
        plt.show()
